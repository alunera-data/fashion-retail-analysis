...
> _This report was written independently. ChatGPT (OpenAI) was used as a tool to assist with structure, phrasing, and quality control.  
> All analysis, implementation, and interpretation were conducted entirely by the author._
...
We check for missing values across datasets:
...
- **Discounts**: Transactions with discounts resulted in significantly lower revenue (~−64 CHF).
- **Product Category**: Categories like “Masculine” performed better than "Children".
- **Payment Method**: Credit card transactions produced slightly higher revenues.

While the model explains about 2.7% of the variance (R² = 0.0271), the identified effects are strong and consistent with practical expectations.
